...
<?php if(USER::isAuth() && ('1' == USER::getThis()->role || '3' == USER::getThis()->role )): ?>
 ...
 <?php MG::titlePage($lang['ADMIN_BAR']);?>
    ...
    <script type="text/javascript" src="<?php echo SITE?>/mg-core/script/admin/admin.js?mgBaseDir=<?php echo SITE; ?>"></script>
     
    
  </head>


<body class="mg-admin-body" style="zoom: 1; background-image: url(<?php echo SITE?>/mg-admin/design/images/bg_textures/<?php echo $data['themeBackground']; ?>.png);">
    <div class="admin-wrapper no-print">
      
        <!--<div class="notice-block top-position">     
            <div  class="message_information inform"> Желаете установить CMS на свой хостинг? <a style="color:#28BB1D" href="http://moguta.ru">Скачать бесплатно</a></div>
        </div>-->
        ...
        <div class="header">
            ...
            <div class="admin-top-menu">
                <ul class="admin-top-menu-list">
                   ...
                   <?php if ('1' == User::getThis()->role) {?>  <li class="no-left-border"><a id="catalog" href="javascript:void(0);" title="<?php echo($lang['T_TIP_PROD']);?>" class="tool-tip-bottom"><span class="product-icon"></span><?php echo($lang['PRODUCTS']);?></a></li><?php }?>
                   <?php if ('1' == User::getThis()->role) {?> <li><a id="statistics" style="display:none" href="javascript:void(0);"><span class="category-icon"></span>1111</a></li><?php }?>
                   <?php if ('1' == User::getThis()->role) {?>  <li><a id="category" href="javascript:void(0);" title="<?php echo($lang['T_TIP_CAT']);?>" class="tool-tip-bottom"><span class="category-icon"></span><?php echo($lang['CATEGORIES']);?></a></li><?php }?>
                   <?php if ('1' == User::getThis()->role) {?> <li><a id="page" href="javascript:void(0);" title="<?php echo($lang['T_TIP_PAGE']);?>" class="tool-tip-bottom"><span class="pages-icon"></span><?php echo($lang['PAGES']);?></a></li><?php }?>
                   ...
                   <?php if ('1' == User::getThis()->role) {?> <li class="no-right-border"><a id="users" href="javascript:void(0);" title="<?php echo($lang['T_TIP_USER']);?>" class="tool-tip-bottom"><span class="users-icon"></span><?php echo($lang['USERS']);?></a></li><?php }?>
        ...
        <div class="admin-footer-block no-print">
            <div class="admin-copyright">
               <p>&copy; Copyright <br/><span style="color:#A01C1C">Вы используете бесплатную версию с установленными ограничениями.</a> 
               <!--<a  style="font-size: 12px;" href="http://moguta.ru/keys/klyuch-na-1-domen">Снять ограничения, приобрести лицензию.</a>-->               
               </p>
