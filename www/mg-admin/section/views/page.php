  ...
  <div class="widget-table-wrapper">
    ...
    <div class="widget-table-body">
      <div class="widget-table-action">
        ...
        <a href="javascript:void(0);" class="custom-btn refresh-visible-cat tool-tip-bottom" title="Вывести все страницы в меню"><span><?php echo $lang['PAGE_LOCALE_3']?></span></a>
      </div>
