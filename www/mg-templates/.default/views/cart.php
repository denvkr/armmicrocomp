	...
	<form method="post" action="<?php echo SITE?>/cart">
		<table class="cart-table">
			...
			<tr>
				...
				<td class="img-cell">
					<a href="
            <?php echo SITE ?>/<?php echo isset($product["category_url"]) ? $product["category_url"] : 'catalog' ?>/<?php echo $product["product_url"] ?>" 
            target="_blank" class="cart-img">
				...
				<td>
					...
					<ul class="action-list">
						<li><button type="submit" name="refresh" class="refresh" title="Пересчитать" value="Пересчитать"></button></li>
						<li><a class="deleteItemFromCart delete-btn" href="<?php echo SITE?>/cart" data-delete-item-id="<?php echo $product['id'] ?>" data-property="<?php echo $product['property'] ?>" data-variant="<?php echo $product['variantId']?>" title="Удалить товар"></a></li>
         </ul>
				</td>
				<td class="price-cell">
			...
			<tr>
				...
				<td class="total-sum-cell"><strong><?php echo $data['totalSumm']; ?> <?php echo $data['currency']; ?></strong></td>
			</tr>
		</table>    
	</form>
