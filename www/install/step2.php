  ...
  <div class="center-wrapper step2">
    ...
    <div class="install-text">
      <form class="add-img-form" method="post" enctype="multipart/form-data" action="" encoding="multipart/form-data" disable>
        <h3 class="bd-title">Настройки базы данных</h3>
        <div class="clear"></div>
        <ul class="product-text-inputs">
          <li>
            <label>
              <span class="custom-text">Имя сервера<span class="red-star">*</span>:</span>
              <input type="text" name="host" class="product-name-input" value="<?php echo $host?>">
            </label>
          </li>
          <li>
            <label>
              <span class="custom-text">Пользователь<span class="red-star">*</span>:</span>
              <input type="text" name="user" class="product-name-input" value="<?php echo $user?>">
            </label>
          </li>
          <li>
            <label>
              <span class="custom-text">Пароль:</span>
